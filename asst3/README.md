...
> It is slightly faster (personal PC). 0.7-1x time needed.
...
> Including the transfer time brings to a 50x time increase required to finish the operation, at ~3GB/s, much less than the GPU's max bandwidth.
